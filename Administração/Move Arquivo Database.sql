/* 
	Quando utilizamos Detach e Atach para mover arquivos perdemos histórico de backups e outras informações.
	Para contornar esse problema vamos mover um arquivo sem utilizar detach e atach
 */
