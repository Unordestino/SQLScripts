...
BEGIN
	...
	BEGIN
		...
		from sys.fn_xe_file_target_read_file
			('C:\Temp\what_queries_are_failing*.xel',
			'C:\Temp\what_queries_are_failing*.xem',
			null, null)
	...
	(set filename = 'C:\Temp\what_queries_are_failing.xel' ,
	metadatafile = 'C:\Temp\what_queries_are_failing.xem',
	max_file_size = 500,
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'DBA - Load XEvent Database Error', 
		...
		@notify_email_operator_name=N'UDEMY',
		@job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
