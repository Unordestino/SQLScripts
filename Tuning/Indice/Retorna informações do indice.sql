------------ varias informações para validar indices duplicados


DECLARE @Nm_Schema VARCHAR(100) = 'dbo', -- Schema
		@Nm_Tabela VARCHAR(200) = 'SA1010' -- Tabela
...
Select distinct B.index_name, B.index_description,B.index_keys,C.includedColumns,A.user_seeks,A.user_scans,A.user_Updates,A.Ultimo_acesso,A.fill_factor,D.IndexSizeKB,E.data_compression_desc,
	'alter index '+B.index_name+ ' on Lancamento REBUILD with(FILLFACTOR=90,DATA_COMPRESSION=ROW)'
