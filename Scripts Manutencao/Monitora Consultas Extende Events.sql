...
-- DROP TABLE ObjectAudit.dbo.DBA_Audit_Query
CREATE TABLE DBA.dbo.DBA_Audit_Query (
...
ADD EVENT sqlserver.rpc_completed(
	...
	AND sqlserver.database_name <> 'ReportServer' AND sqlserver.database_name <> 'ReportServerTempDB' AND duration > 30000000),
ADD EVENT sqlserver.sql_statement_completed(
    ACTION(package0.collect_cpu_cycle_time,package0.collect_system_time,package0.event_sequence,sqlos.task_time,sqlserver.client_app_name,sqlserver.client_connection_id,sqlserver.client_hostname,sqlserver.client_pid,sqlserver.database_name,sqlserver.nt_username,sqlserver.server_instance_name,sqlserver.session_id,sqlserver.session_nt_username,sqlserver.sql_text,sqlserver.username)
	WHERE sqlserver.database_name <> 'master' AND sqlserver.database_name <> 'msdb' AND sqlserver.database_name <> 'tempdb' 
	AND sqlserver.database_name <> 'ReportServer' AND sqlserver.database_name <> 'ReportServerTempDB' AND duration > 30000000)
ADD TARGET package0.event_file(SET filename=N'F:\DBA_Log\Consultas\MonitoraConsultas.xel',max_file_size=(100),max_rollover_files=(20))
...
/**************************************
 Importa dados
***************************************/
-- truncate table ObjectAudit.dbo.DBA_Audit_Query

insert DBA.dbo.DBA_Audit_Query
...
FROM sys.fn_xe_file_target_read_file('F:\DBA_Log\Consultas\MonitoraConsultas*.xel', NULL, NULL, NULL)
...
FROM sys.fn_xe_file_target_read_file('F:\DBA_Log\Consultas\MonitoraConsultas*.xel',
null, null, null)  AS f;


select Comando,COUNT(*)   
from DBA.dbo.DBA_Audit_Query
group by Comando
order by 2 desc

select name, object_name, type_name, description 
